...
<div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="/teachercourse">查看课程 <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link grade" href="/addgrade">录入成绩 <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item active">
    ...
    <div style="width: 500px;">
        ...
        <div class="input-group mb-3">
            ...
            <button type="button" id="update" class="btn btn-danger btn-sm">修改</button>
        </div>
        ...
        <div class="input-group mb-3">
            <div class="input-group-prepend">
                <button class="btn btn-outline-secondary" type="button">我的职级</button>
            </div>
            <input type="text" id="rank" name="rank" class="form-control" autocomplete="off" disabled="disabled">
        </div>

        <div class="input-group mb-3">
            <div class="input-group-prepend">
                <button class="btn btn-outline-secondary" type="button">工号</button>
            </div>
            <input type="text" id="userId" name="userId" class="form-control" value="${user.userId}" autocomplete="off" disabled="disabled">
        </div>
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" id="username" name="username" class="form-control" value="${user.username}" autocomplete="off">
        </div>
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" id="sex" name="sex" class="form-control" value="${user.sex}" autocomplete="off">
        </div>
    </div>
    </form>
    <div class="jumbotron">
        <h1 class="display-4">Hello, ${user.username}</h1>
        <p class="lead">高高兴兴上班来</p>
        <hr class="my-4">
        <p>平平安安回家去</p>
...
<script>
    ...
    $("#update").click(function () {
        $.ajax({
            type: 'post',
            url: 'updateUser',
            data: {userId:$("#userId").val(),username:$("#username").val(),sex:$("#sex").val()},
            success: function () {
